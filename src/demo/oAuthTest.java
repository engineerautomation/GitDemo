...
public class oAuthTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\eclipse-workspace\\demo\\BrowserDriver\\chromedriver.exe");

		ChromeOptions options = new ChromeOptions();
//options.addArguments("user-data-dir=C:\\Users\\rahul\\AppData\\Local\\Google\\Chrome\\User Data");
		// System.setProperty("webdriver.chrome.driver",
		// "C:\\eclipse-workspace\\demo\\BrowserDriver\\chromedriver.exe");
	//	options.setBinary("C:\\eclipse-workspace\\demo\\BrowserDriver\\chrome-win64\\chrome.exe");
		...
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("input[type='email']")).sendKeys("engineerautomation7");
		driver.findElement(By.cssSelector("input[type='email']")).sendKeys(Keys.ENTER);
		Thread.sleep(5000); driver.manage().window().maximize();
		driver.findElement(By.cssSelector("input[type='password']")).sendKeys("Restapi@2025");
...
//			
	...
	String strResponse =	given().queryParam("access_token", accessToken).expect().defaultParser(Parser.JSON).when()
		.get("https://rahulshettyacademy.com/getCourse.php").then().extract().response().asString();
	System.out.println("");
	System.out.println("");
